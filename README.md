...
Decentralized applications (dApps) are revolutionizing the ride-sharing industry, challenging traditional platforms with the potential for lower costs and fairer profit distribution for drivers and users. This paper tackles current limitations like opaque pricing structures and high commissions by exploring the integration of dApps with geofencing technology. Geofencing leverages GPS or RFID to create virtual boundaries ("geofences") around designated locations.
